...
// Run thisif the oninit setting is defined
// thislogic will fire the oninit callback ones each
...
// Setup tinyMCEPreInit object thiswill later be used by the TinyMCE
...
// Add :tinymce pseudo selector thiswill select elements that has been converted into editor instances
// it's now possible to use things like $('*:tinymce') to get all TinyMCE bound elements.
p.extend(p.expr[":"],{tinymce:function(e){var t;return!!(e.id&&"tinymce"in d&&(t=v().get(e.id))&&t.editorManager===v())}});
// thisfunction patches internal jQuery functions so that if
