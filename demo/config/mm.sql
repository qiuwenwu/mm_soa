...
CREATE TABLE `dev_order`  (
  `order_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '订单唯一ID：[0,2147483647]',
  `orderid` varchar(125) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '订单ID：[0,125]',
  `name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '项目名：[0,64]',
  `price` decimal(10, 2) NOT NULL COMMENT '单价：',
  `doc` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '需求文档：',
  `file` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '需求文件：[0,255]',
  `lang` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '语言：[0,32]',
  `mode` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '模式：(MVC|MVVM)',
  `ui` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'UI框架：[0,64]',
  `db` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '数据库：[0,64]',
  `framework` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '程序架构：[0,64]',
  `state` smallint(6) UNSIGNED NOT NULL DEFAULT 1 COMMENT '订单状态：[0,32767](1待取单|2待开发|3进行中|4已完成|5修改中|6已删除)',
  `balance` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '已结算：[0,1](0否|1是)',
  `tpl_home` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '前台模板：[0,64]',
  `tpl_admin` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '后台模板：[0,64]',
  `publisher` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '录入员：[0,32]',
  `handler` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '技术员：[0,32]',
  `time_create` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间：',
  `time_update` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间：',
  `time_end` datetime(0) NOT NULL DEFAULT '1970-01-01 00:00:00' COMMENT '结束时间：',
  `dispose_log` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '部署记录：时间+空格+部署人，多次部署换行表示',
  `config` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '配置信息',
  PRIMARY KEY (`order_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 20 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单信息：' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of dev_order
-- ----------------------------
INSERT INTO `dev_order` VALUES (2, 'CS20211231', '校园宿舍管理系统', 130.00, NULL, NULL, 'python', 'MVC', 'bootstarp', 'mysql', 'django', 1, 1, NULL, NULL, '晓斌', '文武', '2021-01-29 00:00:00', '2021-01-31 23:06:49', '1970-01-01 00:00:00', '', NULL);
INSERT INTO `dev_order` VALUES (3, 'CS20211031', '电商管理系统', 100.00, NULL, NULL, 'nodejs', 'MVVM', 'element', 'mysql', 'uni-app', 1, 0, NULL, NULL, '晓斌', '润彬', '2021-01-30 00:00:00', '2021-01-31 23:06:47', '1970-01-01 00:00:00', '', NULL);
INSERT INTO `dev_order` VALUES (4, '', '', 100.00, '', '', NULL, NULL, NULL, NULL, NULL, 2, 0, NULL, NULL, '晓斌', '润彬', '2021-01-31 21:01:01', '2021-02-01 11:46:58', '1970-01-01 00:00:00', '', NULL);
INSERT INTO `dev_order` VALUES (5, '', 'python商城管理系统1', 100.00, '', '', NULL, NULL, NULL, NULL, NULL, 5, 0, NULL, NULL, '晓斌', '润彬', '2021-01-31 21:21:17', '2021-02-01 11:46:59', '1970-01-01 00:00:00', '', NULL);
INSERT INTO `dev_order` VALUES (6, 'CS478310_20210131_213056_undefined', 'django校园管理系统', 100.00, '', '', NULL, NULL, NULL, NULL, NULL, 2, 0, NULL, NULL, '晓斌', '文韬', '2021-01-31 21:30:56', '2021-02-01 11:46:59', '1970-01-01 00:00:00', '', NULL);
INSERT INTO `dev_order` VALUES (7, 'CS528130_20210131213729', 'nodejs摄影展览网站', 100.00, '', '', NULL, 'MVC', NULL, NULL, NULL, 1, 0, NULL, NULL, '晓斌', '润彬', '2021-01-31 00:00:00', '2021-02-01 11:47:00', '1970-01-01 00:00:00', '', NULL);
INSERT INTO `dev_order` VALUES (8, 'CS856060_20210131220709', '', 100.00, '', '', NULL, 'MVC', NULL, NULL, NULL, 3, 0, NULL, NULL, '晓斌', '文韬', '2021-01-31 00:00:00', '2021-02-01 00:00:00', '1970-01-01 00:00:00', '', NULL);
INSERT INTO `dev_order` VALUES (9, 'CS149890_20210131220750', '', 100.00, '', '', NULL, 'MVVM', NULL, NULL, NULL, 1, 0, NULL, NULL, '晓斌', '文韬', '2021-01-31 00:00:00', '2021-02-01 00:00:00', '1970-01-01 00:00:00', '', NULL);
INSERT INTO `dev_order` VALUES (10, 'CS801520_20210131220758', '', 100.00, '', '', NULL, 'MVC', NULL, NULL, NULL, 3, 0, NULL, NULL, '晓斌', '润彬', '2021-01-31 00:00:00', '2021-02-01 00:00:00', '1970-01-01 00:00:00', '', NULL);
INSERT INTO `dev_order` VALUES (11, 'CS669330_20210131220817', '', 100.00, '', '', 'java', 'MVVM', NULL, NULL, NULL, 1, 0, NULL, NULL, '晓斌', '文韬', '2021-01-31 00:00:00', '2021-02-01 00:00:00', '1970-01-01 00:00:00', '', NULL);
INSERT INTO `dev_order` VALUES (12, 'CS351690_20210131220822', '', 100.00, '', '', NULL, 'MVVM', NULL, NULL, NULL, 4, 0, NULL, NULL, '晓斌', '文韬', '2021-01-31 00:00:00', '2021-02-01 00:00:00', '1970-01-01 00:00:00', '', NULL);
INSERT INTO `dev_order` VALUES (13, 'CS676900_20210131220826', '', 100.00, '', '', 'java', 'MVC', NULL, NULL, NULL, 5, 1, NULL, NULL, '晓斌', '文韬', '2021-01-31 00:00:00', '2021-02-01 00:00:00', '1970-01-01 00:00:00', '', NULL);
INSERT INTO `dev_order` VALUES (14, 'CS903500_20210131220845', '', 100.00, '', '', 'java', 'MVC', NULL, NULL, NULL, 1, 0, NULL, NULL, '晓斌', '润彬', '2021-01-31 00:00:00', '2021-02-01 00:00:00', '1970-01-01 00:00:00', '', NULL);
INSERT INTO `dev_order` VALUES (15, 'CS396450_20210131220850', '', 100.00, '', '', NULL, NULL, NULL, NULL, NULL, 6, 0, NULL, NULL, '晓斌', '润彬', '2021-01-31 22:08:50', '2021-02-01 11:47:07', '1970-01-01 00:00:00', '', NULL);
INSERT INTO `dev_order` VALUES (16, 'CS309310_20210131220850', '', 100.00, '', '', NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL, '晓斌', '文韬', '2021-01-31 22:08:50', '2021-02-01 11:47:08', '1970-01-01 00:00:00', '', NULL);
INSERT INTO `dev_order` VALUES (17, 'CS479630_20210131220854', '', 100.00, '', '', 'php', 'MVC', NULL, NULL, NULL, 4, 0, NULL, NULL, '晓斌', '润彬', '2021-01-31 00:00:00', '2021-02-01 00:00:00', '1970-01-01 00:00:00', '', NULL);
INSERT INTO `dev_order` VALUES (18, 'CS983580_20210131220956', 'baeaarer', 100.00, '<p>123123123123bbbb1212312313212312312123123123123bbb</p>', '', 'java', 'MVC', NULL, NULL, NULL, 4, 1, NULL, NULL, '晓斌', '文韬', '2021-01-31 00:00:00', '2021-02-02 17:13:52', '1970-01-01 00:00:00', '', NULL);
INSERT INTO `dev_order` VALUES (19, 'CS984210_20210131220958', '', 100.00, '', '', NULL, NULL, NULL, NULL, NULL, 6, 0, NULL, NULL, '晓斌', '润彬', '2021-01-31 00:00:00', '2021-02-01 11:47:10', '1970-01-01 00:00:00', '', NULL);
