							...
							<div class="card_body">
								<mm_form class="mm_filter">
									...
									<mm_list col="3">
										...
										<mm_item>
											<mm_select v-model="query.type_id" title="服务分类" :options="$to_kv(list_type, 'type_id', 'name')"
											 @change="search()" />
										</mm_item>
										<mm_item>
											<mm_select v-model="query.user_id" title="下单用户" :options="$to_kv(list_account, 'user_id', 'nickname')"
											 @change="search()" />
										</mm_item>
										<mm_item>
								...
								<mm_table type="2">
									<thead class="table-sm">
										<tr>
											...
											<th>
												<mm_reverse title="服务分类" v-model="query.orderby" field="type_id" :func="search"></mm_reverse>
											</th>
											<th>
												<mm_reverse title="下单用户" v-model="query.orderby" field="user_id" :func="search"></mm_reverse>
											</th>
											<th>
											...
											<th>
												<mm_reverse title="价格" v-model="query.orderby" field="price" :func="search"></mm_reverse>
											</th>
											<th>
												<mm_reverse title="原价" v-model="query.orderby" field="price_ago" :func="search"></mm_reverse>
											</th>
											<th>
												<mm_reverse title="有效期至" v-model="query.orderby" field="time_validity" :func="search"></mm_reverse>
											</th>
											<th>
											...
											<th>
												<mm_reverse title="联系电话" v-model="query.orderby" field="user_phone" :func="search"></mm_reverse>
											</th>
											<th>
