						...
						<mm_card>
							...
							<div class="card_body">
								<mm_form class="mm_filter">
									...
									<mm_list col="3">
										<mm_item>
											<mm_input v-model="query.keyword" title="关键词" desc="服务者姓名 / 正文"
											 @blur="search()" />
										</mm_item>
										<mm_item>
								...
								<mm_table type="2">
									<thead class="table-sm">
										<tr>
											...
											<th>
												<mm_reverse title="服务定价" v-model="query.orderby" field="price" :func="search"></mm_reverse>
											</th>
											<th>
											...
											<th>
												<mm_reverse title="服务项" v-model="query.orderby" field="items" :func="search"></mm_reverse>
											</th>
											<th>
